            ...
            <div className='container py-5'>
                <div className='row text-center text-lg-start'>
                    ...
                    <div className='col-lg-4 mb-4 mb-lg-0'>
                        <h3>Contact Us</h3>
                        <p className='pt-3'><i className="fa-solid fa-location-dot"></i> Location</p>
                        <p><i className="fa-solid fa-phone"></i> Call +91-9876543210</p>
                        <p><i className="fa-solid fa-envelope"></i> eatandmeet@gmail.com</p>
                    </div>
                    ...
                    <div className='col-lg-4 mb-4 mb-lg-0'>
                        ...
                        <div className='d-flex justify-content-center justify-content-lg-start gap-3 pt-2'>
                            <i className="fa-brands fa-instagram" id='icon'></i>
                            <i className="fab fa-facebook-f" id='icon'></i>
                            <i className="fab fa-twitter" id='icon'></i>
                            <i className="fa-brands fa-linkedin-in" id='icon'></i>
